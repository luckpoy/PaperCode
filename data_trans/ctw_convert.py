...
if __name__ == '__main__':
    ...
    CTW_text_convertor = CTWConvertor(jsonl_path=r'/home/tml/bo/CRAFT/CRAFT-Remade/ctw/ctw-annotations/train.jsonl',
                                      image_root=r'/home/tml/bo/CRAFT/CRAFT-Remade/ctw/images-trainval')
    craft_sample_list = CTW_text_convertor.convert_to_craft()

    # image = plt.imread(craft_sample_list[0][0])
    # image = Image.fromarray(image)
    # draw = ImageDraw.Draw(image)
    # for i in craft_sample_list[0][1]:
    #     for j in i:
    #         draw.polygon((j[0][0],j[0][1],j[1][0],j[1][1],j[2][0],j[2][1],j[3][0],j[3][1]), outline = 'green')
    # image.save("/home/tml/bo/CRAFT/CRAFT-Remade/debug/draw.png")


    # for line in craft_sample_list:
    #     try:
    #         image = plt.imread(os.path.join('/home/tml/bo/CRAFT/CRAFT-Remade/ctw/images-trainval/', line[0]))
    #         plt.close
    #     except:
    #         print(line[0])
    #         a = line[0]
    #         cmd = "sed -i '/" + a  + "/d'  /home/tml/bo/CRAFT/CRAFT-Remade/ctw/ctw-annotations/train.jsonl"
    #         os.system(cmd)

    for line in craft_sample_list:
        if os.path.exists(os.path.join('/home/tml/bo/CRAFT/CRAFT-Remade/ctw/images-trainval/', line[0])):
            continue
        else:
            print(line[0])
            a = line[0]
